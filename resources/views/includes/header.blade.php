...
<div id="header" class="header {{ $headerClass }} shadow-md">
	...
	<div class="navbar-header">
		...
		@endif
		<a href="{{ route('superadmin.index') }}" class="pl-3">
			<img src="{{ asset('/assets/img/auth/logo.png') }}" class="h-[40px] mx-auto cursor-pointer" />	
		</a>		@if ($headerMegaMenu)
		...
		<li class="dropdown navbar-user">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">
				@if (Auth::user()->name === 'Super Admin')
					<img src="{{ asset('assets/img/auth/superadmin.png') }}" alt="superadmin icon" />
				@else 
					<img src="{{ asset('assets/img/auth/admin.png') }}" alt="admin icon" />
				@endif 
