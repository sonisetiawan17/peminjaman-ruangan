...
<main class="bg-[#f7f7f8]">
    <div class="py-[35px] mx-[8px] md:mx-[50px] lg:mx-[15px]">
        <div class="bg-white border border-neutral-400 rounded-xl" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
            <div class="border-b border-neutral-200 mx-[2px] md:mx-[12px]">
            ...
            <div class="flex flex-col gap-3 my-4">
                @foreach ($fasilitasArray as $fasilitas)
                    <div class="mx-[8px] lg:mx-12 bg-white p-[12px] rounded-md" style="box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
