            ...
            <ul class="timeline">
                <li>
                    <div class="timeline-time">
                        ...
                        <span class="time">{{ \Carbon\Carbon::parse($data->created_at)->format('d M Y') }}</span>
                    </div>
                    ...
                    <div class="timeline-body">
                        <div class="timeline-header">
                            <span class="username" style="text-transform:uppercase;"># {{$data->nama_kegiatan}}</span>
                            <span class="views" style="text-transform:capitalize;">{{$data->user->name}}</span>
                        </div>
                        ...
                        <div class="timeline-likes">
                            <div class="stats-right">
                                <span class="stats-text">
                                    ...
                                    {{ \Carbon\Carbon::parse($data->tgl_mulai)->format('d') }} s/d
                                    {{ \Carbon\Carbon::parse($data->tgl_selesai)->format('d M Y') }}
                                </span>
                                <span class="stats-text"><i class="fa fa-clock"></i> {{ sprintf("%02d", $data->jam_mulai) }}:00 - {{ sprintf("%02d", $data->jam_selesai) }}:00</span>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    <div class="timeline-time">
                        ...
                        <span class="time">{{ \Carbon\Carbon::parse($data->diubah)->format('d M Y') }}</span>
                    </div>
                    ...
                    <div class="timeline-body">
                        <div class="timeline-header">  
                            ...
                            <span class="views inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-100 text-green-800">Pengajuan Anda {{ $data->status_permohonan }} <i class="fa fa-check-circle text-green"></i></span>
                ...
                <li>
                    ...
                    <div class="timeline-body">
                        <div class="timeline-header">                            
                            ...
                            <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-500 text-white">Pengajuan Anda {{ $data->status_permohonan }}</span>
                            @else
                            <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-100 text-red-800">Pengajuan Anda {{ $data->status_permohonan }}</span>
                            @endif
                    ...
                    <div class="bg-white shadow-sm border p-[15px] md:p-[25px]">
                        ...
                        <div class="md:grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-3 gap-y-10 mt-4">
                            <div class="">
                                ...
                                <p class="pt-2 text-neutral-500">{{ $data->skpd === 'skpd' ? 'Skpd' : 'Non Skpd' }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">Bidang Kegiatan</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->bidang_kegiatan }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">No KTP</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->user->nik }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">Nama Pemohon</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->user->name }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">No Telepon</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->user->no_telp }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">Email</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->user->email }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">Nama Instansi/Pribadi</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->user->instansi->nama_instansi }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                            ...
                            <div class="mt-[20px] md:mt-0">
                                ...
                                <p class="pt-2 text-neutral-500">{{ $data->user->alamat_instansi }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-sm border p-[15px] md:p-[25px] mt-5">
                        ...
                        <div class="md:grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-3 gap-y-10 mt-4">
                            ...
                            <div class="mt-[20px] md:mt-0">
                                ...
                                <p class="pt-2 text-neutral-500">{{ $data->jumlah_peserta }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                            ...
                            <div class="mt-[20px] md:mt-0">
                                ...
                                <div class="gallery ml-2 mt-2">
                                    <a href="/file_upload/{{ $data->surat_permohonan }}" data-lightbox="gallery-group-1">
                            ...
                            <div class="mt-[20px] md:mt-0">
                                ...
                                <div class="gallery ml-2 mt-2">
                                    <a href="/file_upload/{{ $data->rundown_acara }}" data-lightbox="gallery-group-1">
                                        <div class="flex flex-row items-center gap-2">
                                            <img src="{{ asset('/assets/img/auth/google-docs.png') }}" class="w-[30px]" />
                                            <p style="font-size: 12px" class="text-blue-500">Lihat File</p>
                                        </div>
                            ...
                            <div class="mt-[20px] md:mt-0">
                                ...
                                <p class="pt-2 text-neutral-500">{{ $data->output === null ? '-' : $data->output }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">Outcome</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->outcome === null ? '-' : $data->outcome }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-sm border p-[15px] md:p-[25px] mt-5">
                        ...
                        <div class="md:grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-3 gap-y-10 mt-4">
                            ...
                            <div class="mt-[20px] md:mt-0mt-[20px] md:mt-0">
                                ...
                                <p class="pt-2 text-neutral-500">{{ $data->fasilitas->nama_fasilitas }}</p>
                            </div>
                            <div class="mt-[20px] md:mt-0mt-[20px] md:mt-0">
                                <h3 class="font-medium">Alat Pendukung</h3>
                                <p class="pt-2 text-neutral-500">
                                    @php
                                        $inputUser = $data->alat_id;
                    ...
                    <div class="bg-white shadow-sm border p-[15px] md:p-[25px] mt-5">
                        ...
                        <div class="md:grid md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-3 gap-y-10 mt-4">
                            ...
                            <div class="mt-[20px] md:mt-0">
                                ...
                                <span class="mt-3 inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-100 text-green-800">{{ $data->status_permohonan }}</span>
                                @elseif ($data->status_permohonan === 'Ditolak')
                                <span class="mt-3 inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-100 text-red-800">{{ $data->status_permohonan }}</span>
                                ...
                                @else 
                                <span class="mt-3 inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-yellow-200 text-yellow-800">{{ $data->status_permohonan }}</span>
                                @endif
                            </div>
                            <div class="mt-[20px] md:mt-0">
                                <h3 class="font-medium">Catatan Admin</h3>
                                <p class="pt-2 text-neutral-500">{{ $data->catatan === null ? '-' : $data->catatan }}</p>
                            </div>
                        </div>
                    </div>
                </div>
